...
export const Bio = {
    ...
    resume:
      "https://drive.google.com/file/d/1u62GFcuRa7p28mH4X6_fXC1bilhi2zsi/view?usp=sharing",
  ...
  export const experiences = [
    {
      ...
      desc: "Worked on an web app for front-end and back-end with proper testing and management of all the things by version control.",
      skills: [
        "ReactJS",
        "Spring Boot",
        "Github",
